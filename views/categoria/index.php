...
<head>
    ...
    <!-- main css -->
    <link rel="stylesheet" href="<?php echo constant('URL') ?>public/css/styleCategories.css">
    <title>CTW | Categoria</title>
</head>
...
<body>
    ...
    <!-- main js -->
    <script src="<?php echo constant('URL'); ?>public/js/mainCategories.js"></script>
</body>
